...
int main (int argc, char *argv[])
{
        ...
        const auto beta   = std::make_shared<Functions::ConstantFunction<dimension, double>>(1.0);
        ...
        const std::set<types::boundary_id> dirichlet_ids = {1};
        const std::set<types::boundary_id> neumann_ids = {0};
