 ...
 * @brief Declaration of the MatrixFreeSolver using MultiGrid as a Preconditioner, class for orchestrating the matrix-free ADR solution.
 */
 ...
 * - Solving the linear system using an iterative solver (GMRES) with Multigrid preconditioning.
