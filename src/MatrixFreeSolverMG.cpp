...
template class MatrixFreeSolverMG<2, 7, double>;
template class MatrixFreeSolverMG<2, 8, double>;
template class MatrixFreeSolverMG<2, 9, double>;
template class MatrixFreeSolverMG<2, 10, double>;
template class MatrixFreeSolverMG<2, 11, double>;
template class MatrixFreeSolverMG<2, 12, double>;
...
template class MatrixFreeSolverMG<3, 7, double>;
template class MatrixFreeSolverMG<3, 8, double>;
template class MatrixFreeSolverMG<3, 9, double>;
template class MatrixFreeSolverMG<3, 10, double>;
template class MatrixFreeSolverMG<3, 11, double>;
template class MatrixFreeSolverMG<3, 12, double>;
